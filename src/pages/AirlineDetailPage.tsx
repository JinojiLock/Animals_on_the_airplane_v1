          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {airline.transportMethods.map((method) => (
                <span
                  key={method}
                  className={`px-4 py-2 bg-${transportMethodConfig[method].color}-100 dark:bg-${transportMethodConfig[method].color}-900/30 text-${transportMethodConfig[method].color}-800 dark:text-${transportMethodConfig[method].color}-200 rounded-lg text-sm font-medium`}
                >
            ...
            <a
              ...
              className="inline-flex items-center bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-600 text-white font-semibold py-3 px-6 rounded-lg transition-colors"
            >
